...
- Name: visiteur-parcours.spec.ts >> TMC-16 : Parcours visiteur >> Navigation publique >> should_navigate_from_accueil_to_livres
- Location: e2e/visiteur-parcours.spec.ts:27:9
...
Call log:
  - waiting for getByRole('link', { name: 'Livres' }).first()
