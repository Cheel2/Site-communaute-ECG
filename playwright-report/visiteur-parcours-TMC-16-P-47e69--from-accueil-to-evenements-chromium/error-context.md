...
- Name: visiteur-parcours.spec.ts >> TMC-16 : Parcours visiteur >> Navigation publique >> should_navigate_from_accueil_to_evenements
- Location: e2e/visiteur-parcours.spec.ts:36:9
...
Call log:
  - waiting for getByRole('link', { name: 'Événements' }).first()
