...
- Name: visiteur-parcours.spec.ts >> TMC-16 : Parcours visiteur >> Navigation publique >> should_navigate_from_accueil_to_contenus
- Location: e2e/visiteur-parcours.spec.ts:18:9
...
Call log:
  - waiting for getByRole('link', { name: 'Contenus' }).first()
