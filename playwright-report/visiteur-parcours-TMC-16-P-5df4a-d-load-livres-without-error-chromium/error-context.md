...
- Name: visiteur-parcours.spec.ts >> TMC-16 : Parcours visiteur >> Page livres >> should_load_livres_without_error
- Location: e2e/visiteur-parcours.spec.ts:85:9
...
Locator: getByRole('heading', { name: 'Nos Livres' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Nos Livres' })
