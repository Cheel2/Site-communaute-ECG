...
- Name: visiteur-parcours.spec.ts >> TMC-16 : Parcours visiteur >> Page événements >> should_display_evenement_cards_or_empty_state
- Location: e2e/visiteur-parcours.spec.ts:118:9
...
Locator: locator('text=Aucun événement')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Aucun événement')
