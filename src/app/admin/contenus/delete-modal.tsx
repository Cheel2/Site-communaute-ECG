  ...
  return (
    ...
    >
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="suppression-contenu-titre"
        className="w-full max-w-md rounded-lg bg-white p-4 shadow-lg"
        onClick={(event) => event.stopPropagation()}
      >
        <h3
          id="suppression-contenu-titre"
        ...
        <p className="mt-2 text-sm text-gray-600">
          Êtes-vous sûr de vouloir supprimer « {contenu.titre} » ? Cette action
          est définitive.
        </p>
